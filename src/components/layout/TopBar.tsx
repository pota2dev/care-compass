  ...
  return (
    <header className="h-16 bg-white border-b border-forest-500/10 px-6 flex items-center justify-between sticky top-0 z-10">
      ...
      <div className="flex items-center gap-3">
        <Link href="/notifications" className="relative p-2 rounded-xl hover:bg-cream-100 transition-colors">
          <Bell className="w-5 h-5 text-forest-400" />
          <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-clay rounded-full"></span>
        </Link>
